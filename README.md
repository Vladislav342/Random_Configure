...
8)Для того, щоб оптимізувати запити до бази даних Redis, нам потрібно написати 
```sh
-> HSET ip:5 impressions 1; 
```
а потім, щоб підвищити на 1 
```sh
-> HINCRBY ip:123 impressions 1;
```
і в такий спосіб, навіть якщо в цей самий момент виконувався паралельний запит до бази даних, то він порахував би правильно.